  ...
  return (
    <div className="w-full flex flex-col items-center justify-center p-10">
      <div className="w-1/2 text-white bg-neutral-700 rounded-lg p-4 space-y-10">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Reside.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>• Website</strong> refers to Reside, accessible from{" "}
              <a
                href="https://www.reside.services"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.reside.services
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-4xl font-bold my-10">Children&apos;s Privacy</h2>
        <p>
        ...
        <h2 className="text-4xl font-bold my-10">Links to Other Websites</h2>
        <p>
        ...
        <ul>
          <li>By email: jaedonaspurlock@outlook.com</li>
        </ul>
      </div>
    </div>
  );
