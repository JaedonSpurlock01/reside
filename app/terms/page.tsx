...
const TermsPage = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center p-10">
      <div className="w-1/2 text-white bg-neutral-700 rounded-lg p-4 space-y-10">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Reside!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of SystemX&apos;s Website, located at www.reside.services.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Reside if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Reside, you agreed to use
          cookies in agreement with the SystemX&apos;s Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, SystemX and/or its licensors own the
          intellectual property rights for all material on Reside. All
          intellectual property rights are reserved. You may access this from
          Reside for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Reside</li>
          <li>Sell, rent or sub-license material from Reside</li>
          <li>Reproduce, duplicate or copy material from Reside</li>
          <li>Redistribute content from Reside</li>
        </ul>
        ...
        <p>
          ...
          SystemX does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of SystemX,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, SystemX shall not be liable
        ...
        <p>
          SystemX reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant SystemX a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of SystemX; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to SystemX. Please include your name, your
        ...
        <p>
          No use of SystemX&apos;s logo or other artwork will be allowed for
